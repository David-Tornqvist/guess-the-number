...
function updateGuesses() {
    if (message.innerHTML === "Too High!") {
        guesses.push(getInput().fontcolor("red"));
    }

    if (message.innerHTML === "Too Low!") {
        guesses.push(getInput().fontcolor("green"));
    }
...
function checkMessage(input) {
    ...
    if (parseInt(input) === randomN) {
        setMessage("Correct," + ` it took you ${guesses.length + 1} guesses`);
